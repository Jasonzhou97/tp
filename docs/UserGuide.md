...
Examples:
* `find John` returns all reservations made by John.
* `find Jane` returns all reservations made by Jane.
* `find John Jane` returns all reservations made by John or Jane.
...
| **Find by name**  | `findn NAME`<br> e.g., `find John Doe`                                                                                                                                                                                                                         | |
| **List all**      | `list`                                                                                                                                                                                                                                                         |
| **List today**    | `listrt`                                                                                                                                                                                                                                                       |
