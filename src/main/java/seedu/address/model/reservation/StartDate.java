...
public class StartDate {
    ...
    public static final String VALIDATION_REGEX =  "^(?:(?:31/(?:0[13578]|1[02]))|"                // 31st valid in Jan, Mar, May, Jul, Aug, Oct, Dec
                    + "(?:(?:29|30)/(?:0[13-9]|1[0-2]))|"               // 29th and 30th valid in all months except Feb
                    + "(?:29/02/(?:(?:(?:1[6-9]|[2-9]\\d)(?:0[48]|[2468][048]|[13579][26]))|(?:(?:16|[2468][048]|[3579][26])00)))|"  // 29th Feb only in leap years
                    + "(?:0[1-9]|1\\d|2[0-8])/(?:0[1-9]|1[0-2]))/(?:1\\d{3}|[2-9]\\d{3})$";  // Days 1-28 valid in any month, year 1000+
