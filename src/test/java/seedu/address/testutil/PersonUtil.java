...
public class PersonUtil {
    ...
    public static String getAddCommand(Reservation reservation) {
        return AddCommand.COMMAND_WORD + " " + getPersonDetails(reservation);
    }

    /**
     * Returns the part of command string for the given {@code person}'s details.
     */
    public static String getPersonDetails(Reservation reservation) {
     ...
     */
    public static String getEditPersonDescriptorDetails(EditCommand.EditReservationDescriptor descriptor) {
        StringBuilder sb = new StringBuilder();
