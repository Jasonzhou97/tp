...
public class PersonsListManagerTest {
    ...
    public void updatePersonsListAfterDelete_decrementCounter() {
        ...
        Reservation reservation = new Reservation(name, phone, null, null, null,
    ...
    public void updatePersonsListAfterEdit_phoneChange() {
        ...
        Reservation oldReservation = new Reservation(name, oldPhone, null, null, null,
                null, null, null, null, null, false);
        Reservation newReservation = new Reservation(name, newPhone, null, null,
